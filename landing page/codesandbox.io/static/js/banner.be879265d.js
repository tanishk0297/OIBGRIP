! function(n) {
    ...
    }, t.p = "https://codesandbox.io/", t(t.s = "./src/banner.js")
}({
    "./src/banner.js": function(n, e) {
        var t;
        var o = function n() {
            if (("undefined" === typeof window || window.location && window.location.href.indexOf("?standalone") > -1 || !window.opener && window.parent === window) && !localStorage.HIDE_PHISHING_BANNER) {
        ...
        try {
            ...
            fetch("https://codesandbox.io/api/v1/sandboxes/".concat(r, "/phishing")).then((function(n) {
                return n.json()
            })).then((function(n) {
                n.deleted && window.location.replace("https://codesandbox.io/phew"), n.flagged && setTimeout((function() {
                    return o()
                }), 250)
            })).catch((function() {}))
        } catch (i) {
